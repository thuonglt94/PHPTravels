...
public class ScriptBase {
	...
	protected <T extends PHPTravelsEvent> T given(T dsl) {
		return dsl;
	}

	protected <T extends PHPTravelsEvent> T when(T dsl) {
		return dsl;
	}

	protected <T extends PHPTravelsEvent> T and(T dsl) {
		return dsl;
	}

	protected <T extends PHPTravelsEvent> T then(T dsl) {
		return dsl;
	}
